...
const twPlugin = plugin(function ({addUtilities, addComponents, addBase, theme, config}) {
    ...
    addComponents({
        ...
        '.tc-list-horizontal': {
            '@apply flex items-center list-none space-x-2': {}
        },
        '.tc-list-ordered': {
            '@apply list-decimal': {}
        },
        ...
        '.tc-list-horizontal li,.tc-list-horizontal li a': {
        ...
        '.tc-modal-overlay': {
            '@apply absolute w-full h-full bg-gray-900/70 dark:bg-gray-600/95 z-30': {}
        },
        ...
        'skin-popup-arrow': {
            '@apply absolute w-4 h-4 bg-inherit border-inherit rotate-45 border-b border-r': {}
        },
        '.tc-tooltip': {
            '@apply px-2 py-1 text-sm max-w-sm': {},
