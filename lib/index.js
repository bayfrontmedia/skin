...
const twPlugin = plugin(function ({addUtilities, addComponents, addBase, theme, config}) {
    ...
    addComponents({
        ...
        '.tc-popup': {
            '@apply z-20 absolute w-max top-0 left-0 hidden scale-90 opacity-0 data-[popup-visible=true]:scale-100 data-[popup-visible=true]:opacity-100 transition ease-in-out duration-200': {}
        },
