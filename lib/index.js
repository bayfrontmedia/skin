...
const twPlugin = plugin(function ({addUtilities, addComponents, addBase, theme, config}) {
    ...
    addComponents({
        ...
        '.tc-style-default': {
            '@apply tu-bg-default tu-border-default tu-text-default focus:tu-ring-default': {}
        },
        '.tc-style-default-o': {
            '@apply hover:tu-bg-default tu-border-default tu-text-default focus:tu-ring-default': {}
        },
        '.tc-style-content': {
            '@apply tu-bg-content tu-border-default tu-text-default focus:tu-ring-default': {}
        },
        '.tc-style-inverse': {
            '@apply tu-bg-inverse tu-border-inverse tu-text-inverse focus:tu-ring-default': {}
        },
        '.tc-style-primary': {
            '@apply bg-theme-primary border-theme-primary text-white focus:tu-ring-primary': {}
        },
        '.tc-style-primary-o': {
            '@apply hover:bg-theme-primary border-theme-primary text-theme-primary hover:text-white focus:tu-ring-primary': {}
        },
        '.tc-style-secondary': {
            '@apply bg-theme-secondary border-theme-secondary text-white focus:tu-ring-secondary': {}
        },
        '.tc-style-secondary-o': {
            '@apply hover:bg-theme-secondary border-theme-secondary text-theme-secondary hover:text-white focus:tu-ring-secondary': {}
        },
        '.tc-style-info': {
            '@apply tu-bg-info tu-border-info tu-text-info focus:tu-ring-info': {}
        },
        '.tc-style-info-o': {
            '@apply hover:tu-bg-info tu-border-info text-blue-500 hover:tu-text-info focus:tu-ring-info': {}
        },
        '.tc-style-info-light': {
            '@apply tu-bg-info-light tu-border-info-light tu-text-info-light focus:tu-ring-info': {}
        },
        '.tc-style-warning': {
            '@apply tu-bg-warning tu-border-warning tu-text-warning focus:tu-ring-warning': {}
        },
        '.tc-style-warning-o': {
            '@apply hover:tu-bg-warning tu-border-warning tu-text-warning-light hover:tu-text-warning focus:tu-ring-warning': {}
        },
        '.tc-style-warning-light': {
            '@apply tu-bg-warning-light tu-border-warning-light tu-text-warning-light focus:tu-ring-warning': {}
        },
        '.tc-style-error': {
            '@apply tu-bg-error tu-border-error tu-text-error focus:tu-ring-error': {}
        },
        '.tc-style-error-o': {
            '@apply hover:tu-bg-error tu-border-error text-red-600 hover:tu-text-error focus:tu-ring-error': {}
        },
        '.tc-style-error-light': {
            '@apply tu-bg-error-light tu-border-error-light tu-text-error-light focus:tu-ring-error': {}
        },
        '.tc-style-success': {
            '@apply tu-bg-success tu-border-success tu-text-success focus:tu-ring-success': {}
        },
        '.tc-style-success-o': {
            '@apply hover:tu-bg-success tu-border-success text-green-500 hover:tu-text-success focus:tu-ring-success': {}
        },
        '.tc-style-success-light': {
            '@apply tu-bg-success-light tu-border-success-light tu-text-success-light focus:tu-ring-success': {}
        },

        /* Alert */

        '.tc-alert': {
            '@apply flex items-center px-3 py-2 tu-border-radius tu-border-width tu-box-shadow': {}
        },
        '.tc-alert-alt': {
            '@apply border-l-4': {}
        },
        ...
        '.tc-badge': {
            '@apply inline-flex items-center text-center px-2 py-0.5 tu-border-radius tu-border-width': {}
        },
        '.tc-badge-pill': {
        ...
        '.tc-blockquote': {
            '@apply p-6 my-12 text-xl tu-border-default border-l-4': {}
        },
        '.tc-blockquote-l,.tc-blockquote-r,.tc-blockquote-alt-l': {
            '@apply mr-4 my-12 md:my-6 md:float-left md:max-w-xs xl:max-w-md': {}
        },
        '.tc-blockquote-r': {
            '@apply md:float-right md:text-right md:border-l-0 md:border-r-4': {}
        },
        '.tc-blockquote-alt': {
            '@apply relative border-0 px-16 my-12': {}
        },
        '.tc-blockquote-alt:before': {
            content: "'“'",
            '@apply absolute top-2 left-0 mr-4 text-8xl text-inherit font-serif': {}
        },
        '.tc-blockquote-alt-r': {
            '@apply ml-4 my-6 md:float-right md:max-w-xs xl:max-w-md md:text-right': {}
        },
        '.tc-blockquote figcaption, .tc-blockquote-alt figcaption': {
            '@apply text-base tu-text-light': {}
        },
        '.tc-blockquote cite': {
            '@apply italic': {}
        },
        ...
        '.tc-btn': {
            '@apply inline-flex items-center text-center px-3 py-2 tu-border-radius tu-border-width cursor-pointer disabled:pointer-events-none filter hover:brightness-95 active:brightness-90 transition-all duration-100': {}
        },
        '.tc-btn *': {
        ...
        '.tc-btn-row *:first-child': {
            '@apply border-r-0 rounded-r-none': {}
        },
        '.tc-btn-row *:last-child': {
            '@apply border-l-0 rounded-l-none': {}
        },
        '.tc-btn-row *:not(:first-child):not(:last-child)': {
            '@apply rounded-none': {}
        },
        '.tc-btn-row *:nth-child(2)': {
            '@apply border-l': {}
        },
        '.tc-btn-col': {
        ...
        '.tc-form-file': {
            '@apply focus:outline-0 file:mr-4 file:-ml-1 file:-my-2 file:p-2 file:border-0 file:cursor-pointer file:tc-style-default file:text-sm file:font-semibold': {}
        },
        '.tc-form-checkbox,.tc-form-radio': {
            '@apply h-5 w-5 text-blue-500 checked:bg-blue-500': {}
        },
        '.tc-form-radio': {
            '@apply rounded-full': {}
        },
        ...
        '.tc-progress': {
            '@apply w-full tu-bg-default tu-border-radius overflow-hidden': {}
        },
        ...
        '.tc-toast': {
            '@apply w-full sm:w-96 flex items-center px-3 py-2 tu-border-radius tu-border-width tu-box-shadow': {}
        },
        '.tc-toast-alt': {
            '@apply border-l-4': {}
        },
    ...
    addUtilities({
        ...
        '.tu-typo code:not(pre *):not(.tu-typo-omit),code:not(pre *).tu-typo-apply,.tu-typo kbd:not(.tu-typo-omit),kbd.tu-typo-apply,.tu-typo samp:not(.tu-typo-omit),samp.tu-typo-apply': {
            '@apply px-1 py-0 tu-border-radius': {}
        },
        ...
        '.tu-typo mark:not(.tu-typo-omit),mark.tu-typo-apply': {
            '@apply px-1 py-0.5 bg-yellow-300 tu-border-radius': {}
        },
        ...
        '.tu-border-radius': {
            borderRadius: skinConfig('borderRadius', '.25rem')
        },
        '.tu-border-width': {
