...
const twPlugin = plugin(function ({addUtilities, addComponents, addBase, theme, config}) {
    ...
    addComponents({
        ...
        '.tc-form-input,.tc-form-file,.tc-form-textarea,.tc-form-select,.tc-form-checkbox,.tc-form-radio': {
            '@apply p-2 border tu-border-radius tc-style-content focus:tu-border-default placeholder:tu-text-light disabled:brightness-90 dark:disabled:brightness-75 focus:ring-0': {}
        },
        '.tc-form-input,.tc-form-file,.tc-form-textarea,.tc-form-select': {
            '@apply block w-full focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-700': {}
        },
        '.tc-form-file': {
        ...
        '.tc-form-toggle': {
            '@apply w-14 h-8 tu-bg-default tu-border-default border rounded-full peer-checked:after:translate-x-full peer-checked:after:border-white peer-checked:bg-blue-500 peer-checked:border-blue-500 after:content-[\'\'] after:absolute after:top-1 after:left-1 after:bg-white after:tu-border-default after:border after:rounded-full after:h-6 after:w-6 after:transition-all': {}
        },
        '.tc-form-toggle.tc-form-toggle-sm': {
            '@apply w-11 h-6 after:top-0.5 after:left-0.5 after:h-5 after:w-5': {}
        },
        '.tc-form-toggle-text': {
            '@apply ml-4': {}
        },
        ...
        '.tc-toast-container': {
            '@apply flex flex-col fixed w-full px-4 sm:px-8 opacity-90 z-20': {}
        },
