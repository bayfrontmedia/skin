...
const twPlugin = plugin(function ({addUtilities, addComponents, addBase, theme, config}) {
    ...
    addComponents({
        ...
        '.tc-blockquote-l,.tc-blockquote-r,.tc-blockquote-quote-l': {
            '@apply mr-4 my-12 md:my-6 md:float-left md:max-w-xs xl:max-w-md': {}
        },
        '.tc-blockquote-c,.tc-blockquote-quote-c': {
        ...
        '.tc-blockquote-quote:before': {
            content: "'“'",
            '@apply absolute top-2 left-0 mr-4 text-8xl text-inherit font-serif': {}
        },
        '.tc-blockquote-quote-r:before': {
            '@apply left-6': {}
        },
        '.tc-blockquote-quote-r': {
            '@apply ml-4 my-6 md:float-right md:max-w-xs xl:max-w-md text-right': {}
        },
        '.tc-blockquote figcaption, .tc-blockquote-quote figcaption': {
            '@apply text-base': {},
        ...
        '.tc-btn': {
            '@apply inline-flex items-center text-center px-3 py-2 cursor-pointer filter hover:brightness-95 active:brightness-90 disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-60 transition-all duration-100': {},
            borderColor: 'var(--skin-border-default)',
            borderRadius: skinConfig('borderRadius', '.5rem'),
            borderWidth: skinConfig('borderWidth', '1px')
        },
        ...
        '.tc-popup': {
            '@apply z-20 absolute w-max top-0 left-0 hidden scale-90 opacity-0 data-[popup-visible=true]:scale-100 data-[popup-visible=true]:opacity-100 transition ease-in-out duration-200 print:hidden': {}
        },

        '.tc-popup-arrow': {
            //'@apply absolute w-6 h-6 border-solid border-t-inherit border-t-8 border-x-transparent border-x-8 border-b-0': {}
            '@apply absolute w-4 h-4 bg-inherit rotate-45': {}
        },


        '.data-popup-arrow,.data-popup-arrow::before': {
            '@apply absolute w-[8px] h-[8px] bg-inherit': {}
        },
        '.data-popup-arrow': {
            '@apply invisible': {}
        },
        '.data-popup-arrow::before': {
            '@apply visible rotate-45 content-[""]': {}
        },
        '[data-popup-placement^="top"] > .data-popup-arrow': {
            '@apply bottom-[-4px]': {}
        },
        '[data-popup-placement^="bottom"] > .data-popup-arrow': {
            '@apply top-[-4px]': {}
        },
        '[data-popup-placement^="left"] > .data-popup-arrow': {
            '@apply right-[-4px]': {}
        },
        '[data-popup-placement^="right"] > .data-popup-arrow': {
            '@apply left-[-4px]': {}
        },
        ...
        'skin-toast-container': {
            '@apply flex flex-col fixed w-auto px-4 sm:px-8 z-20': {}
        },
        'skin-toast-container[data-style="tl"]': {
            '@apply items-start top-4 left-0': {}
        },
        'skin-toast-container[data-style="tr"]': {
            '@apply items-end top-4 right-0': {}
        },
        'skin-toast-container[data-style="bl"]': {
            '@apply items-start bottom-4 left-0': {}
        },
        'skin-toast-container[data-style="br"]': {
            '@apply items-end bottom-4 right-0': {}
        },
        'skin-toast': {
            '@apply w-96 flex items-center px-3 py-2': {},
            borderRadius: skinConfig('borderRadius', '.5rem'),
            borderWidth: skinConfig('borderWidth', '1px'),
            boxShadow: skinConfig('boxShadow', '0 4px 6px -1px rgb(0 0 0 / 0.1), 0 2px 4px -2px rgb(0 0 0 / 0.1);')
        },
        'skin-toast[data-style="bt"]': {
            '@apply border-t-4': {}
        },
        'skin-toast[data-style="br"]': {
            '@apply border-r-4': {}
        },
        'skin-toast[data-style="bb"]': {
            '@apply border-b-4': {}
        },
        'skin-toast[data-style="bl"]': {
            '@apply border-l-4': {}
        },


        /* Styles - Added last so they overwrite other components */
