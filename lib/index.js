...
const twPlugin = plugin(function ({addUtilities, addComponents, addBase, theme, config}) {
    ...
    addComponents({
        ...
        See: https://tailwindcss.com/docs/hover-focus-and-other-states#form-states
         */
        ...
        '.tc-form-input,.tc-form-file,.tc-form-textarea,.tc-form-select,.tc-form-checkbox,.tc-form-radio': {
            '@apply p-2 border tu-border-radius tc-style-content dark:tu-bg-default placeholder:tu-text-light disabled:brightness-90 dark:disabled:brightness-75 focus:ring-offset-0 focus:ring-2 focus:ring-blue-400 dark:focus:ring-blue-700 focus:border-blue-400 dark:focus:border-blue-700': {}
        },
        '.tc-form-input,.tc-form-file,.tc-form-textarea,.tc-form-select': {
            '@apply block w-full': {}
        },
        '.tc-form-file': {
            '@apply focus:outline-0 file:mr-4 file:-my-1 file:p-1 file:border-0 file:cursor-pointer file:tc-style-default file:text-sm file:font-semibold': {}
        },
        ...
        '.tc-form-toggle,.tc-form-toggle-sm': {
            '@apply tu-bg-default tu-border-default border rounded-full peer-checked:after:translate-x-full peer-checked:after:border-white peer-checked:bg-blue-500 peer-checked:border-blue-500 after:content-[\'\'] after:absolute after:bg-white after:tu-border-default after:border after:rounded-full after:transition-all': {}
        },
        '.tc-form-toggle': {
        ...
        '.tc-form-status-info': {
            '@apply tc-style-info-light focus:tu-border-info-light focus:ring-blue-400 dark:focus:ring-blue-700': {}
        },
        '.tc-form-status-warning': {
            '@apply tc-style-warning-light focus:tu-border-warning-light focus:ring-yellow-400 dark:focus:ring-yellow-700': {}
        },
        '.tc-form-status-error': {
            '@apply tc-style-error-light focus:tu-border-error-light focus:ring-red-400 dark:focus:ring-red-700': {}
        },
        '.tc-form-status-success': {
            '@apply tc-style-success-light focus:tu-border-success-light focus:ring-green-400 dark:focus:ring-green-700': {}
        },
        ...
        '.form-group .text-help': {
            '@apply text-sm font-semibold tu-text-error-light': {}
        },
